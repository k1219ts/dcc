...
private:
    ...
    RtInt m_filter;
    RtInt m_lerp;
    RtColorRGB m_missingColor;
    RtFloat m_missingAlpha;
    RtInt m_linearize;
    RtInt m_mipBias;
    RtFloat m_maxResolution;
    RtInt m_optimizeIndirect;
    RtColorRGB m_colorScale;
    RtColorRGB m_colorOffset;
    RtFloat m_alphaScale;
    RtFloat m_alphaOffset;
...
int
DxTexture::ComputeOutputParams(RixShadingContext const *sctx,
