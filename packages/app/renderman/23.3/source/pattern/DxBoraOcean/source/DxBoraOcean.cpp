...
class DxBoraOcean : public RixPattern
{
    public:
        ...
        virtual int ComputeOutputParams(RixShadingContext const *, RtInt *n, RixPattern::OutputSpec **outputs, RtPointer instanceData, RixSCParamInfo const *) override;
        virtual bool Bake2dOutput( RixBakeContext const*, Bake2dSpec&, RtPointer ) override { return false; }
        virtual bool Bake3dOutput( RixBakeContext const*, Bake3dSpec&, RtPointer ) override { return false; }
...
void DxBoraOcean::CreateInstanceData(
...
void DxBoraOcean::initializeInstanceData(
...
void DxBoraOcean::SynchronizeInstanceData(RixContext& rixCtx, RtUString const handle,
