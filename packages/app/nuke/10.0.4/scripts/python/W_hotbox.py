...
enableChangeableIconLocation = False
...
extraRepositories = []
#extraRepositories = ['Global', '/netapp/backstage/pub/apps/nuke/Globals/python/W_hotbox/']
#extraRepositories.append(['NAME','/path/to/extra/repository/W_hotbox/'])
extraRepositories.append(['Global','/backstage/apps/Nuke/Globals/python/W_hotbox/'])
'''
