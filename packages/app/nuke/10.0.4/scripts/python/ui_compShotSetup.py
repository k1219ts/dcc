...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.setup_gridLayout.setColumnStretch(1, 2)
        ...
        self.cam_treeWidget.headerItem().setText(1, 'Version')
        self.cam_treeWidget.headerItem().setText(2, 'Over Scan')
        self.cam_treeWidget.headerItem().setText(3, 'Stereo')
        self.cam_treeWidget.headerItem().setText(4, 'Time')
        ...
        self.cam_treeWidget.header().resizeSection(4, 100)
