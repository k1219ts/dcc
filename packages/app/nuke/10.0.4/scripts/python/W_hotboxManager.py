...
class hotboxManager(QtWidgets.QWidget):
    def __init__(self, path = ''):
        ...
        self.classesListAddButton.buttonClicked.connect(self.addClass)
        self.classesListRemoveButton.buttonClicked.connect(self.removeClass)
        self.classesListRenameButton.buttonClicked.connect(self.renameClass)
        ...
        self.hotboxItemsTreeAddButton.buttonClicked.connect(self.hotboxItemsTree.addItem)
        self.hotboxItemsTreeAddFolderButton.buttonClicked.connect(lambda: self.hotboxItemsTree.addItem(True))
        self.hotboxItemsTreeRemoveButton.buttonClicked.connect(self.hotboxItemsTree.removeItem)
        self.hotboxItemsTreeDuplicateButton.buttonClicked.connect(self.hotboxItemsTree.duplicateItem)
        self.hotboxItemsTreeCopyButton.buttonClicked.connect(self.hotboxItemsTree.copyItem)
        self.hotboxItemsTreePasteButton.buttonClicked.connect(self.hotboxItemsTree.pasteItem)
        ...
        self.scriptEditorName = QtWidgets.QLineEdit()
        ...
        self.scriptEditorScript = QtWidgets.QPlainTextEdit()
        ...
        self.scriptEditorSaveButton = QtWidgets.QPushButton('Save')
...
class QTreeViewCustom(QtWidgets.QTreeView):
    def __init__(self, parentClass):
        ...
        self.dataModel = QtWidgets.QStandardItemModel()
