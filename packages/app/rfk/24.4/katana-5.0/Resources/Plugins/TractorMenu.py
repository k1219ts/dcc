...
def RenderMainProc(renderNode, onlyDenoise=False, localQueue=False):
    ...
    from .JobScript import prmanRender as prmanRender
    from .JobScript import renderLog as renderLog
    ...
    render.titleSuffix = ','.join(nodeData.keys())
