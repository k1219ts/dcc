            ...
            if self.makeMov:
                for output in rs.outputs:
                    if output['name'] == 'primary':
                        ...
                        #command = ['/backstage/dcc/DCC', 'rez-env', 'rv', '--', 'rvio', output['outputLocation'], '-o', outputMov, '-out709']
                        command = ['/backstage/dcc/DCC', 'rez-env', 'rv-7.9.2', '--', 'rvio', output['outputLocation'], '-o',
                                   outputMov, '-out709']
