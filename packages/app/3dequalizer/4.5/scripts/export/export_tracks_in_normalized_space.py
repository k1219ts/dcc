#
#
# 3DE4.script.name:	Export 2D Tracks in Normalized Space...
#
# 3DE4.script.version:	v1.4.1
#
...
#
# 3DE4.script.comment:	Writes the 2D tracking curves of all selected points to an Ascii file in normalized space.
#
#
