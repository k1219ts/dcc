...
CompTeam.addCommand("compWrite/EXR/EXR", "compWrite.compWrite('exr')","F10")
...
Project_Setting.addCommand('Setting QNED', 'projectSetting.settingQNED()')
...
# CATTERY
catRoot = '/backstage/dcc/packages/app/nuke_scripts/4.0/scripts/Cattery'
nkRoot = os.environ['REZ_NUKE_SCRIPTS_BASE'] + '/scripts/toolset/CATTERY/'
cat = nuke.menu('Nodes').addMenu('Cattery',icon = catRoot+'/icon/CatteryMenu.png')
cat.addCommand('ABME_Retime','nuke.loadToolset("'+nkRoot+'ABME_Retime.nk")', icon=catRoot+'/ABME/ABME.png')
cat.addCommand('ABME_SV','nuke.loadToolset("'+nkRoot+'ABME_SV.nk")',icon = catRoot+'/ABME/ABME.png')
cat.addCommand('BackgroundMatting','nuke.loadToolset("'+nkRoot+'BackgroundMatting.nk")',icon = catRoot+'/BackgroundMatting/BackgroundMatting.png')
cat.addCommand('FaceMakeup','nuke.loadToolset("'+nkRoot+'FaceMakeup.nk")',icon = catRoot+'/FaceMakeup/Face_Parsing.png')
cat.addCommand('MiDaS','nuke.loadToolset("'+nkRoot+'MiDaS.nk")',icon = catRoot+'/MiDaS/MiDaS.png')
cat.addCommand('MODNet','nuke.loadToolset("'+nkRoot+'MODNet.nk")',icon = catRoot+'/MODNet/MODNet.png')
cat.addCommand('RAFT','nuke.loadToolset("'+nkRoot+'RAFT.nk")',icon = catRoot+'/RAFT/RAFT.png')
cat.addCommand('RealESRGAN','nuke.loadToolset("'+nkRoot+'RealESRGAN.nk")',icon = catRoot+'/RealESRGAN/RealESRGAN.png')
cat.addCommand('SemanticSegmentation','nuke.loadToolset("'+nkRoot+'SemanticSegmentation.nk")',icon = catRoot+'/SemanticSegmentation/Semantic.png')
cat.addCommand('MultiStyleTransfer','nuke.loadToolset("'+nkRoot+'MultiStyleTransfer.nk")',icon = catRoot+'/MultiStyleTransfer/MultiStyleTransfer.png')
cat.addCommand('TecoGAN','nuke.loadToolset("'+nkRoot+'TecoGAN.nk")',icon = catRoot+'/TecoGAN/TecoGAN.png')
