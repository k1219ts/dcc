...
def makeMaskTiffWrite(show, seq, shotName, task, department, argv):
    ...
    shuffle["fromInput1"].setValue("0 B")
    shuffle["fromInput2"].setValue("0 B")
    shuffle["mappings"].fromScript("4 rgba.alpha 0 3 rgba.alpha 0 3 rgba.alpha 0 3 rgba.red 0 0 rgba.alpha 0 3 rgba.green 0 1 rgba.alpha 0 3 rgba.blue 0 2")
