...
from handlers.qt_handlers import QtCore, QtGui, QtOpenGL, QtGui2
...
class BackgroundWidget(QtGui.QLabel):
    ...
    def __init__(self,
        ...
        self.setBackgroundRole(QtGui2.QPalette.Base)
...
class SnapshotWidget(BackgroundWidget):
    ...
    def set_background(self, path=None):
        ...
        # Load image
        image = QtGui2.QImage(path)
        self.setPixmap(QtGui2.QPixmap.fromImage(image))
...
class OverlayWidget(QtGui.QWidget):
    ...
    def set_overlay_background(self, color=QtGui2.QColor(20, 20, 20, 90)):
        palette = QtGui2.QPalette(self.parent().palette())
...
#        self.setDragMode(self.RubberBandDrag)
        ...
        brush = QtGui2.QBrush(QtGui2.QColor(70,70,70,255))
...
#        self.drag_active = False
    ...
    def set_background(self, path=None):
        ...
        self.background_image = QtGui2.QImage(path).mirrored(False, True)
    ...
    def draw_overlay_axis(self, painter, rect):
        ...
        '''
        # Set Pen
        pen = QtGui2.QPen(QtGui2.QColor(160,160,160,120),
                         1,
                         QtCore.Qt.DashLine)
        painter.setPen(pen)
...
class DefaultPolygon(QtGui.QGraphicsObject):
    ...
    '''
    __DEFAULT_COLOR__ = QtGui2.QColor(0,0,0,255)
    ...
    def set_color(self, color=None):
        ...
        if not color:
            ...
            color = QtGui2.QColor(*color)

        assert isinstance(color, QtGui2.QColor), 'input color"%s" is invalid'
...
class PointHandle(DefaultPolygon):
    ...
    '''
    __DEFAULT_COLOR__ = QtGui2.QColor(30,30,30,200)
...
#        path.addRect(rectangle)
    ...
    def paint(self, painter, options, widget=None):
        ...
        '''
        if __USE_OPENGL__:
            painter.setRenderHint(QtGui2.QPainter.HighQualityAntialiasing)
        else:
        ...
        brush = QtGui2.QBrush(self.color)
        if self._hovered:
            brush = QtGui2.QBrush(self.color.lighter(500))

        # Paint background
        painter.fillPath(path, brush)

        border_pen = QtGui2.QPen(QtGui2.QColor(200,200,200,255))
        ...
        painter.setPen( QtGui2.QColor(0,0,0,180) )
    ...
    def scale_pos(self, x=1.0, y=1.0):
        ...
        '''
        factor = QtGui2.QTransform().scale(x, y)
...
class Polygon(DefaultPolygon):
    ...
    '''
    __DEFAULT_COLOR__ = QtGui2.QColor(200,200,200,180)
    __DEFAULT_SELECT_COLOR__ = QtGui2.QColor(0,30,0,180)
    ...
    def shape(self):
        ...
        if len(self.points)>2:
            ...
            # Draw polygon
            polygon = QtGui2.QPolygonF(shp_points)
        ...
        # Circle case
            ...
            radius = QtGui2.QVector2D(self.points[0].pos()-self.points[1].pos()).length()
    ...
    def paint(self, painter, options, widget=None):
        ...
        # Background color
        color = QtGui2.QColor(self.color)
        if self._hovered:
            color = color.lighter(130)
        brush = QtGui2.QBrush(color)

        painter.fillPath(path, brush)

        # Add white layer color overlay on selected state
        if self.selected:
            color = QtGui2.QColor(255,255,255, 50)
            brush = QtGui2.QBrush(color)
            painter.fillPath(path, brush)

        # Border status feedback
        border_pen = QtGui2.QPen(self.__DEFAULT_SELECT_COLOR__)
        ...
        # Paint center cross
        painter.setRenderHints(QtGui2.QPainter.HighQualityAntialiasing, False)
        painter.setPen( QtGui2.QColor(0,0,0,180) )
...
class PointHandleIndex(QtGui.QGraphicsSimpleTextItem):
    ...
    '''
    __DEFAULT_COLOR__ = QtGui2.QColor(130,50,50,255)
...
class GraphicText(QtGui.QGraphicsSimpleTextItem):
    ...
    '''
    __DEFAULT_COLOR__ = QtGui2.QColor(30,30,30,255)

    def __init__(self, parent=None, scene=None):
        QtGui.QGraphicsSimpleTextItem.__init__(self, parent, scene)

        # Counter view scale
        self.scale_transform = QtGui2.QTransform().scale(1, -1)
...
#
#        # Set node background color
#        brush = QtGui2.QBrush(QtGui2.QColor(0,0,200,255))
#
#        # Paint background
#        painter.fillPath(path, brush)
#
#        border_pen = QtGui2.QPen(QtGui2.QColor(0,200,0,255))
#        painter.setPen(border_pen)
#
#        # Paint Borders
#        painter.drawPath(path)
...
#        menu.addAction(reset_action)
    ...
    def mirror_color(self):
        ...
        new_color = QtGui2.QColor(old_color.blue(),
                                 old_color.green(),
                                 old_color.red(),
    ...
    def set_data(self, data):
        ...
        # Set color
        if 'color' in data:
            color = QtGui2.QColor(*data['color'])
        ...
        if 'text' in data:
            ...
            color = QtGui2.QColor(*data['text_color'])
...
class ItemOptionsWindow(QtGui.QMainWindow):
    ...
    def _set_color_button(self, color):
        palette = QtGui2.QPalette()
        palette.setColor(QtGui2.QPalette.Button, color)
...
#
    ...
    def change_color_event(self):
        ...
        color = QtGui2.QColorDialog.getColor(initial=self.picker_item.get_color(),
                                            parent=self)
    ...
    def change_text_color_event(self):
        ...
        # Open color picker dialog
        color = QtGui2.QColorDialog.getColor(initial=self.picker_item.get_text_color(),
                                            parent=self)
