...
dxConfigInfo = {'KOR':{'DB_IP'     : '10.0.0.12:27017',
                   #'DB_IP'     : '10.0.0.12:27017, 10.0.0.13:27017',
                   'TACTIC_IP' : '10.0.0.51',
                   'TRACTOR_KATANA_IP' : ['10.10.10.71', '10.0.0.35' ],
                   'TRACTOR_IP': '10.10.10.71',
                   'TRACTOR_CACHE_IP': '10.0.0.25',
                   'TRACTOR_REDSHIFT_IP': '10.0.0.25',
                   'TRACTOR_NUKE_IP': ['10.0.0.106', '10.0.0.35'],
                   'TRACTOR_PORT': 80,
                   'TRACTOR_API': {
...
def getConf(key):
    house = getHouse()
    if key in dxConfigInfo[house]:
        val = dxConfigInfo[house][key]
...
def getKeyList():
    house = getHouse()
    return dxConfigInfo[house].keys()
