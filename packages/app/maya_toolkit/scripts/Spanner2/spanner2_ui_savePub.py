...
class savePub_Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.addInventory_checkBox = QtGui.QCheckBox(Form)
        self.addInventory_checkBox.setObjectName(_fromUtf8("addInventory_checkBox"))
        self.gridLayout_5.addWidget(self.addInventory_checkBox, 4, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.addInventory_checkBox.setText(_translate("Form", "add to inventory", None))
