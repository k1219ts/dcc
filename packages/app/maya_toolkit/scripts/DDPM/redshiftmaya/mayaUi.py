...
UIFILE = os.sep.join([CURRENT_DIR, 'resource', 'ui', '{uifile}'])
...
class RedshiftWindow(QtWidgets.QWidget):
    uifile = UIFILE.format(uifile='redshiftOptionUi.ui')
    ...
    def __init__(self, parent=None):
        ...
        self.camera_tableWidget.setColumnWidth(1, 60)
        ...
        self.sequencer_tableWidget.setColumnWidth(0, 100)
        ...
        # self.render_Btn.setStyleSheet('QPushButton {background-color: rgb(60, 0, 0)}')
