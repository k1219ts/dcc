...
# Form implementation generated from reading ui file 'ui/CrowdDialog.ui'
#
# Created: Mon Jan 29 11:51:53 2018
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.hashTagEdit = QtGui.QLineEdit(Form)
        self.hashTagEdit.setObjectName(_fromUtf8("hashTagEdit"))
        self.gridLayout.addWidget(self.hashTagEdit, 5, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Crowd 데이터 업로드", None))
        ...
        self.label_5.setText(_translate("Form", "ma File Path", None))
        ...
        self.hashTagEdit.setPlaceholderText(_translate("Form", "ex) god sword jahong ...", None))
