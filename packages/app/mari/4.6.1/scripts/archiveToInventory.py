...
class projectViewDialog(QtGui.QDialog):
    def __init__(self, parent = None):
        ...
        for project in mari.projects.list():
            ...
            item.setIcon(Qt.QtGui.QIcon(os.path.join(self.cachePath, project.uuid(), 'ScreenShot.png')))
    ...
    def exportArchive(self):
        ...
        if findItem.count() == 1:
            ...
            dialog = QtGui.QMessageBox()
            dialog.setFont(Qt.QtGui.QFont("Cantarell", 13))
