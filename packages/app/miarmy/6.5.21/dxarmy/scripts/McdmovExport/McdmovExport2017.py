...
import os
import dxUI
# scrPath = '/netapp/backstage/pub/apps/miarmy2/scripts'
...
uiFile = os.path.join(os.path.dirname(currentpath), "McdmovExport2017.ui")
...
class Window(QtWidgets.QMainWindow):
    ...
    def crtAct(self):
        McdFunctionModified.McdCreateActionCmd(self.showAn)
    ...
    def savAct(self):
        ...
        McdFunctionModified.McdSaveAction(self.animDir[0])  # Save Action
