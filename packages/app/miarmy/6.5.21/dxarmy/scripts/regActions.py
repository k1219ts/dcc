...
uiFile = os.path.join(os.path.dirname(currentpath), "ui/regActionsUI.ui")
...
class Window(QtWidgets.QMainWindow):
    ...
    def connectSignal(self):
        ...
        self.refrBtn.setIcon(QtGui.QPixmap("/backstage/apps/Miarmy/versions/2017/icons/ref.png"))
        ...
        self.refBtn.setIcon(QtGui.QPixmap("/backstage/apps/Miarmy/versions/2017/icons/ref.png"))
        self.refr_ContCopy()
    ...
    def McdCreateAction_OLD(self, actionName, activeAgentName, prompt=True):
        ...
        if temp == None or temp == []:
            ...
            if prompt:
                ...
                raise Exception("ActionShell exist.")
