...
uiFile = os.path.join(os.path.dirname(currentpath), "../ui/offsetKeyframeRestore.ui")
...
class Window(QtWidgets.QMainWindow):
    ...
    def openMan(self):
        exp = "/usr/bin/evince"
        fileName = "/dexter/Cache_DATA/animation/A0_Artist/Choi_SeokWon/MyManual/offsetRestoring.pdf"
