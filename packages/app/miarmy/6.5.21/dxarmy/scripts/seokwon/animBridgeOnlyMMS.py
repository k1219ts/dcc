...
uiFile = "/netapp/backstage/pub/apps/maya2/versions/2017/team/animation/linux/scripts/animBridge/animBridge.ui"
...
class Window(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.mocapJoint_list = ['Crw_Hips', 'Crw_Spine', 'Crw_Spine1', 'Crw_Spine2', 'Crw_Spine3', 'Crw_Neck',
                                ...
                                'Crw_RightToeBase']
        self.FKController_list = ['root_CON', 'C_IK_splineLowbody_CON', 'C_FK_spline2_CON', 'C_FK_spline4_CON', 'C_IK_splineUpbody_CON', 'C_IK_neck_CON', 'C_IK_head_CON', 'L_FK_shoulder_CON', 'L_FK_upArm_CON', 'L_FK_foreArm_CON', 'L_FK_hand_CON', 'R_FK_shoulder_CON', 'R_FK_upArm_CON', 'R_FK_foreArm_CON', 'R_FK_hand_CON', 'L_FK_leg_CON', 'L_FK_lowLeg_CON', 'L_FK_foot_CON', 'R_FK_leg_CON', 'R_FK_lowLeg_CON', 'R_FK_foot_CON']
        ...
        self.IKController_list = ['root_CON', 'C_IK_splineLowbody_CON', 'C_FK_spline2_CON', 'C_FK_spline4_CON', 'C_IK_splineUpbody_CON', 'C_IK_neck_CON', 'C_IK_head_CON', 'L_FK_shoulder_CON', 'L_IK_hand_CON', 'R_FK_shoulder_CON', 'R_IK_hand_CON', 'L_IK_foot_CON', 'R_IK_foot_CON', 'L_IK_handVec_CON', 'R_IK_handVec_CON', 'L_IK_footVec_CON', 'R_IK_footVec_CON']
    ...
    def connectSignal(self):
        ...
        self.tutBtn.setIcon(QtGui.QIcon(QtGui.QPixmap("/dexter/Cache_DATA/animation/A0_Artist/Choi_SeokWon/icons/system-help.png")))
    ...
    def tut(self):
        exp = "/usr/bin/evince"
        fileName = "/dexter/Cache_DATA/animation/A0_Artist/Choi_SeokWon/MyManual/animBridge.pdf"
    ...
    def getMcp(self):
        ...
        with undoCheck():
            ...
            cmds.file('/dexter/Cache_DATA/animation/A14_Asset/HumanIK_for_AnimBrowser/mocapJoint.ma', i=True, type='mayaAscii', ra=True, mergeNamespacesOnClash=True, namespace=self.nsChar + "_mcp", options='v=0')
    ...
    def impMc(self):
        ...
        with undoCheck():
            ...
            self.blendCheck()
            cmds.select(cl=True)
            scrP = "/dexter/Cache_DATA/MCP/02_Data/02_CharMocap"
            ...
            # Save Toes Keyframes
            toeDict = dict()
            toes = {"mcp:Crw_LeftToeBase": self.nsChar + ":L_IK_ball_CON",
                    "mcp:Crw_RightToeBase": self.nsChar + ":R_IK_ball_CON"}
    ...
    def hTomEx(self, inputPath):
        ...
        with undoCheck():
            ...
            cmds.file('/dexter/Cache_DATA/animation/A14_Asset/HumanIK_for_AnimBrowser/HIKJoint.ma', i=True, type='mayaAscii', ra=True, mergeNamespacesOnClash=True, namespace="mcap", options='v=0')
            HIKJoint_constraint_list = []
            for i in range(len(self.mocapJoint_list)):
