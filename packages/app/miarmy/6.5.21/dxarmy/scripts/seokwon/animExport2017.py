...
uiFile = os.path.join(os.path.dirname(currentpath), "../ui/animExport.ui")

MCP_PREVIEW_FILE = '/dexter/Cache_DATA/MCP/01_Asset/02_Char/00_Human/Human_v01/humanType01_skinning.ma'
...
class Window(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        ui = QtCompat.load_ui(uiFile, self)
        setup_ui(ui, self)
        self.checkPlugIn()
        self.connectSignal()
