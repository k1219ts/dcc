...
class WaterTools(object):
    ...
    def createROPNode(self):
        ...
        fetchNode.addSpareParmTuple(hou.StringParmTemplate("pathToNode", "Path To Node", 1,
                                                           string_type=hou.stringParmType.NodeReference))
        fetchNode.parm("pathToNode").set(fileIONode)

        expression = hou.StringKeyframe()
        e = 'hou.pwd().parm("pathToNode").evalAsString()+"/ropnet1/layers_wedge/execute"'
