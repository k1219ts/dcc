...
class DXC_mantra(object):
    ...
    def getHoudiniParms(self):
        ...
        self.SUBSTEP = self.node.parm("f3").eval()
    ...
    def renderPath(self):
        ...
        ##renderPath += self.fileName + "/"
        renderPath += self.ELEMENT_VERSION + "/" + self.FX_GROUP + "/"
