...
class ROP(object):
    def __init__(self, currentNode, parentTask, hipFile="", envKey = ""):
    ...
    def makeNodeTask(self):
        ...
        if self.isSimulation:
            ...
            if self.range:
                ...
                # chunkGroupTask.envkey = self.envKey
    ...
    def makeChunkTask(self, startFrame, endFrame):
        ...
        # chunkTask.envkey = self.envKey
        #mountCommand = ['mount', '-a']
        ...
        renderCommand  = ['hython', '%s/renderScript.py' % _current_path]
        ...
        renderCommand += ['-bundle', os.getenv('BUNDLE_NAME')]
        command = author.Command(
            argv=renderCommand,
