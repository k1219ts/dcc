...
# Form implementation generated from reading ui file 'mantraNetworkRender.ui'
#
# Created: Tue Jul 12 11:43:55 2016
...
class Ui_NetworkRender(object):
    def setupUi(self, NetworkRender):
        ...
        NetworkRender.resize(400, 300)
        self.horizontalLayout_4 = QtGui.QHBoxLayout(NetworkRender)
        ...
        self.tb_Enable = QtGui.QToolButton(NetworkRender)
        ...
        self.tb_Disable = QtGui.QToolButton(NetworkRender)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
