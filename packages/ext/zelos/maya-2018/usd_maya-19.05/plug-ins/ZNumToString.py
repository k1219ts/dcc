...
class ZNumToString( OpenMayaMPx.MPxNode ):
	...
	# class variables
	inputObj     = OpenMaya.MObject()
	scaleObj     = OpenMaya.MObject()
	precisionObj = OpenMaya.MObject()
	unitObj      = OpenMaya.MObject()
	outputObj    = OpenMaya.MObject()
...
def initializePlugin( mobject ):
	mplugin = OpenMayaMPx.MFnPlugin( mobject, 'Dexter Studios', '1.0', 'Any' )
	try:
