...
class UsdExport:
    ...
    def __init__(self, filename, nodes, fr=[None, None], fs=0.0, customLayerData=dict(), **kwargs):
        ...
        self.opts = {
            ...
            #'exportReferenceObjects': True,#  not supported in pxrUsd 21.11
            'referenceObjectMode':"defaultToMesh",
            'kind': 'component',
...
#
#-------------------------------------------------------------------------------
def CoalesceFiles(frameFiles, frameRange, fps=24, step=1, outFile=None, activeOffset=0.0, clipSet='default'):
    ...
    UsdUtils.StitchClipsTemplate(
        outLayer, topologyLayer, topologyLayer, clipPath, templatePath, frameRange[0], frameRange[1], stride, activeOffset, False, clipSet
    )
