...
class ARigAssetExporter(AExport):
    def __init__(self, **kwargs):
        ...
        self.txVarNum = []              # exported mesh txVerNum.
...
class ARigShotExporter(AExport):
    def __init__(self, **kwargs):
        ...
        # exporter compute
        self.geomfiles = []             # exported geom filename.
        self.abcFiles = []              # exported geom alembic for vendor.
...
class RigShotBase(Export):
    ...
    def Arguing(self):
        ...
        self.gArgs.txVarNum = self.arg.txVarNum
        return var.SUCCESS
    ...
    def Tweaking(self):
        ...
        twks << twk.ModifyMayaNurbsAddAttrs(self.arg)   # add custom attribute for nurbsCurve
        twks << twk.MasterRigPack(self.arg)             # master rig geom package
