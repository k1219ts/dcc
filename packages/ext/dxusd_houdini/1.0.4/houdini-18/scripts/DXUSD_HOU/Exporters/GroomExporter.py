...
class AGroomExporter(AExport):
    ...
    def SceneExport(self, sceneFile):
        ...
        print('pubSceneFile:',pubSceneFile)
...
class GroomExporter(Export):
    ...
    def Arguing(self):
        ...
        self.cmArg_high.rules.append(['/.*/high/.*', self.arg.dprim, False])
        ...
        self.cmArg_low.rules.append(['/.*/low/.*', self.arg.dprim, False])
    ...
    def Tweaking(self):
        ...
        twks << twk.HCombineGroomLayers(self.cmArg_high, self.texData)
        twks << twk.HCombineGroomLayers(self.cmArg_low, self.texData)
