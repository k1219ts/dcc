...
try:    from fnpxr import Sdf, Usd, UsdGeom, Vt, Gf
except: from pxr import Sdf, Usd, UsdGeom, Vt, Gf
...
class LoopClip(Tweaker):
    ...
    def Treat(self, srcfile, timeScale):
        ...
        # valueclip for loop
        if customLayerData.get('start') and customLayerData.get('end'):
