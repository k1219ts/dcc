...
def make_log_stamp_dev(platePath, start, end, shotName, username, is1011=False):
    #backup_prefix = sys.exec_prefix
...
#make_log_stamp(imagePath, 1, 280, 'TRI_1390', 'taehyung.lee', True)
