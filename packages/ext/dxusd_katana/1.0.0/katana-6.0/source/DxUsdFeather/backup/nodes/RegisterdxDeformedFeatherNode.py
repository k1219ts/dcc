def registerDeformedFeather():
    from Katana import Nodes3DAPI
    from Katana import FnAttribute

    def builddxDeformedFeatherOpChain(node, interface):
        ...
        interface.appendOp('DxDeformedFeather', argsGb.build())

    nodeTypeBuilder = Nodes3DAPI.NodeTypeBuilder('DxDeformedFeather')
    ...
    nodeTypeBuilder.setBuildOpChainFnc(builddxDeformedFeatherOpChain)
    nodeTypeBuilder.build()

registerDeformedFeather()
